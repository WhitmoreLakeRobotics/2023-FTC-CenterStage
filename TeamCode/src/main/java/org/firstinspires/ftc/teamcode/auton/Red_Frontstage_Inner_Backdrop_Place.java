...
//@Disabled
@Autonomous(name = "Red_Frontstage_Inner_Backdrop_Place", group = "Auton")
// @Autonomous(...) is the other common choice

public class Red_Frontstage_Inner_Backdrop_Place extends OpMode {
   ...
   // private double AUTO_TURN_SPEED = DriveTrain.DRIVETRAIN_TURNSPEED;
    ...
    private final int LeftDistance =6 ;
    ...
    public void loop() {
        ...
        switch (currentStage){
            ...
            case _22_Drive_Back:
                if(robot.driveTrain.getCmdComplete()) {
                    robot.driveTrain.CmdDrive(16, -166, 0.35, 31);
            ...
            case _32_Drive_Back:
                if(robot.driveTrain.getCmdComplete()) {
                    robot.driveTrain.CmdDrive(5, -175, 0.35, 0);
            ...
            case _95_Park_And_Turn:
                if (robot.driveTrain.getCmdComplete()) {
                    robot.driveTrain.CmdDrive(PlaceDistance+5,0,0.35,0);
