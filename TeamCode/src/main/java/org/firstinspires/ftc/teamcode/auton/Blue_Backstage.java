...
//@Disabled
@Autonomous(name = "Blue_Backstage", group = "Auton")
// @Autonomous(...) is the other common choice

public class Blue_Backstage extends OpMode {
        ...
        switch (currentStage){
            ...
            case _50_Turn_To_Backdrop:
                if(robot.driveTrain.getCmdComplete()) {
                    ...
                    currentStage = stage._55_Strafe_To_Wall;

                }
                break;

            case _55_Strafe_To_Wall:
                if(robot.driveTrain.getCmdComplete()) {
                    robot.driveTrain.cmdDriveBySensors(3, 0, 0.35, -90, DriveTrain.SensorSel.LEFT_SIDE);
...
*/
            ...
            case _95_Park_And_Turn:
                if (robot.driveTrain.getCmdComplete()) {
                    ...
                    robot.driveTrain.cmdDriveBySensors(1,0,0.35,0, DriveTrain.SensorSel.REAR);
